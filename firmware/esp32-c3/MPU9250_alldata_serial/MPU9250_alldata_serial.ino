/*
Esse programa le os dados de um acelerômetro MPU9250 e coloca eles em uma forma
formatada na porta serial

Acelerometro (x, y, z), Giroscópio (x, y, z), Magnetometro (x, y, z)
*/
